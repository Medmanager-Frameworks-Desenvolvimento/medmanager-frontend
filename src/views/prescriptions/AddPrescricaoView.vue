<template>
  <div class="max-w-4xl mx-auto">
    <h2 class="text-xl font-extrabold text-[#2b4c5e] mb-6">Adicionar Prescrição</h2>
    ...
    <div class="bg-white p-8 rounded-xl border border-gray-200 shadow-sm relative">
      ...
      <form @submit.prevent="salvarPrescricao" class="space-y-6 relative z-20">
...
const carregarDadosBase = async () => {
  try {
    ...
    alertMessage.value = 'Não foi possível carregar as listas do sistema. Recarregue a página.';
  }
};
...
const salvarPrescricao = async () => {
  ...
  try {
    ...
    await PrescricoesService.criar(payload);
